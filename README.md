_Gerty is the developer studio for exploring the eBay API. Gerty makes working with the API faster and easier, and is available for Windows and Linux users._
